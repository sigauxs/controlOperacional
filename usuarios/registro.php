...
?>
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h2 class="text-center encabezado_listado fw-bolder mt-5">Registrar usuario</h2>
                    ...
                    <div class="card-body bg-transparent">
                        ...
                        <div class="my-3 row">
                              ...
                              <div class="d-grid gap-2 col-sm-12 col-md-4">
                                    <a href="./lista.php" id="Cancelar" class="btn  btn-lg  fw-bolder btn-consultar   btn-lg     btn-consultar--border" style="border-radius: 10px;">Cancelar</a>
                              </div>
