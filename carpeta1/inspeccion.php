...
<?php include("./components/brand.php") ?>
    ...
    <script>
        ...
        const url_registro_inspeccion = "https://sigpeco.sigpeconsultores.com.co/server/inspeccionRegister.php";
                ...
                if (response == "success") {
                    Swal.fire({
                        ...
                        if (!result.isConfirmed) {
                            location.href = "https://sigpeco.sigpeconsultores.com.co/menu.php";
                        } else {
                            location.href = "https://sigpeco.sigpeconsultores.com.co/hallazgo2.php"
                        }
                    })
                }
            })
