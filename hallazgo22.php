                       ...
                       /*=== input radio buttons ===*/
                        ...
                        $(document).ready(function(e) {
                          ...
                          buttonRegister.addEventListener("click", (e) => {
                            ...
                            setTimeout(()=>{ 
                                        let radiobuttonH = document.querySelectorAll(".thallazgo");
                                        if( radiobuttonH == 0 ){
                            ...
                            let textArea = document.getElementById("descripcionActividad"); 
                              ...
                              $(".thallazgo").ready(function() {
                                ...
                                if (radiobutton[1].value == 0) {
                                  selectDesviaciones.lastChild.style.display =  "none" ;
                              ...
                              $(".thallazgo").change(function() {
                                ...
                                let selectDesviaciones = form.elements[2];
                                let ultimoValor = selectDesviaciones.lastChild.value;
                                let primerValor = selectDesviaciones.firstChild.value;
                                const labelHallazgo = document.getElementById("labelAc");
                                ...
                                if (valor == 1) {
                                  ...
                                  $(`#${selectDesviaciones.id}`).each(function() {
                                  ...
                                  selectDesviaciones.lastChild.style.display = "block";
                                  selectDesviaciones.value = ultimoValor;
                                  selectDesviaciones.disabled = "";
                                  form.elements['accionesTomadas'].style.display = "none";
                                  labelHallazgo.style.display = "none";
                                 ...
                                 /*Evaluando el valor de text area cuando es tipo de negativo*/        
                                 if(textArea.value == ""){
                                        buttonSave.setAttribute("disabled","true");
                                    }else{
                                         buttonSave.removeAttribute("disabled");
                                 ...
                                 /* End Evaluando el valor de text area cuando es tipo de negativo */
                                  ...
                                  selectDesviaciones.lastChild.style.display = "none";
                                  selectDesviaciones.value = primerValor;
                                  selectDesviaciones.disabled = "";
