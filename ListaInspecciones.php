      ...
      const mostrar = (inspecciones) => {
        ...
        <td style='border-bottom:1px solid #adb5bd !important; width:100%'>
                        ...
                        <div class='col-4 col-sm-4 float-start p-1 text-end'>
                            <span style='padding-right: 5vw'> <a style="text-decoration:none;${  inspeccion['IDINSPECTOR'] == idUsuario.value | tipoUsuario == administrador ? 'color:red' : 'color:gray'} ; font-weight:bolder;" ${ inspeccion['IDINSPECTOR'] == idUsuario.value | tipoUsuario == administrador ? "href" : " "}="https://controlope.sigpeconsultores.com.co/editarInspeccion.php?idInspeccion=${inspeccion["ID INSP"]}"> ${"COD" + " " + inspeccion["ID INSP"]} </a> </span>
                        </div>
                        </div>
