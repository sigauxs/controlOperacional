...
$url = substr(__DIR__, 0, ($url_count - 5));
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 title-sm">
                <h2 class="text-center encabezado_listado fw-bolder mt-5">Gestionar Factor </h2>
            ...
            <div class="row">
                <div class="col-md-4" id="busquedas">
                    <label for="myInput" class="ms-4 mb-3">
                        ...
                        <input type="text" id="myInput" class="form-control ms-4 mb-3" onkeyup="myFunction()" title="Ingresar numero de identificación" placeholder="&#xF002; Buscar por nombre....." style="font-family:Arial, FontAwesome">
                    </label>
                </div>
            ...
            <div class="col-md-12">
                ...
                <button id="btnCrear" style="color:white" class="btn-crear btn btn-register">Crear Factor</button>
            </div>
                </div>
            </div>
        </div>
    ...
    <div id="modalFactor" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-modal text-white">
                    <h5 class="modal-title" id="exampleModalLabel">Ingresar Factor</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="" method="POST" id="formFactor">
                        <div class="mb-3">
                ...
                <div class="modal-footer" style="display:block">
                    <div class="row">
                        <div class="col-6">
                            <button type="button" id="btnAcciones" style="width:100%; margin:0" class="btn btn-save">Guardar</button>
                        </div>
                        <div class="col-6">
