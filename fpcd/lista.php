...
<body>
    ...
    <div class="row">
        <div class="col-md-12 title-sm">
          <h2 class="text-center encabezado_listado fw-bolder mt-5">Gestionar FPCD </h2>
      ...
      <div class="col-md-4" id="busquedas">
        ...
        <div class="row">
            <div class="col-md-2 text-center">
                <button id="btnCrear" style="color:white" class="btn-crear btn btn-register">Registrar Factor</button>
            </div>

            <div class="col-md-2 text-center">
                <a href="../peligro/lista.php" style="color:white" class="btn-crear btn btn-register">Registrar Peligro</a>
            </div>
        </div>
    </div>
