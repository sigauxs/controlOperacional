...
const fetchDataSelect = async (vp_idsede,dpto,area,selector,locacion) => {
  ...
  var url = new URL("https://controlope.sigpeconsultores.com.co/server/inspeccion-server.php");
...
const SelectDelegadoyPertenece = async (area,locacion,rol,selector) => {
  ...
  var url = new URL("https://controlope.sigpeconsultores.com.co/server/select_delegado.php");
